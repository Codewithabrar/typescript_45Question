...
function make_album(artist_name:string, album_title:string , tracks ?: number){
    let albums_list:{
        name:string, title:string , tracks ?: number}={
        name :artist_name,
        title:album_title,
    };
    if(tracks !== undefined){
...
let album1= make_album("Rihana","album title 1",4);
let album2= make_album("drake","album title 2" , 7);
let album3= make_album("queen","album title 3",19);
